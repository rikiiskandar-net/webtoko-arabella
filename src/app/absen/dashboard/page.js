...
export default function WorkerDashboard() {
  ...
  const STATUS_OPTIONS = [
    { value: "Kerja Normal",   emoji: "✅", label: "Kerja Normal",  mult: "1x Gaji",   multiplierVal: 1,   activeClass: styles.statusPillNormalActive },
    { value: "Lembur Penuh",   emoji: "⚡", label: "Lembur Penuh",  mult: "2x Gaji",   multiplierVal: 2,   activeClass: styles.statusPillLemburActive },
    { value: "Setengah Hari",  emoji: "🌤️", label: "Setengah Hari", mult: "0.5x Gaji", multiplierVal: 0.5, activeClass: styles.statusPillSetengahActive },
    { value: "Sakit",          emoji: "🩺", label: "Sakit",         mult: "0x Gaji",   multiplierVal: 0,   activeClass: styles.statusPillSakitActive },
    { value: "Izin",           emoji: "📋", label: "Izin",          mult: "0x Gaji",   multiplierVal: 0,   activeClass: styles.statusPillIzinActive },
    { value: "Absen",          emoji: "❌", label: "Absen",         mult: "0x Gaji",   multiplierVal: 0,   activeClass: styles.statusPillAbsenActive },
  ];
